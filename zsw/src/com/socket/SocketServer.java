...
public class SocketServer implements Runnable {
	...
	if (msg.content.equals(".bye")){
            ...
            if(msg.type.equals("login")){
            ...
            else if( msg.type.equals("encryptdecrypt")){
                if( msg.type1.equals("encrypt"))
                {
                   if(msg.recipient.equals("All")){
                    Announce("encrypt", msg.sender, msg.content);
                }
                    else{
                        findUserThread(msg.recipient).send(new Message(msg.type, msg.sender,msg.content , msg.recipient , msg.type1));
                        clients[findClient(ID)].send(new Message(msg.type, msg.sender, msg.content , msg.recipient , msg.type1));
                    } 
                }
                
                
                else if( msg.type1.equals("encryptRSA"))
                {     
                    
                    if(msg.recipient.equals("All")){
                          Announce("encryptRSA", msg.sender, msg.encKey );
                    }
                    else
                    { 
                                           
                        findUserThread(msg.recipient).send(new Message(msg.type, msg.sender, msg.content , msg.encKey, msg.recipient , msg.type1));
                        clients[findClient(ID)].send(new Message(msg.type, msg.sender, msg.content , msg.encKey, msg.recipient , msg.type1));
                    }
                ...
                else if(msg.type.equals("askForKey"))
            {
                if(msg.recipient.equals("All")){
                    Announce("message", msg.sender, msg.content);
                }
            ...
            else if(msg.type.equals("keySent"))
            {
                if(msg.recipient.equals("All")){
                    Announce("message", msg.sender, msg.content);
                }
                else{
                    findUserThread(msg.recipient).send(new Message(msg.type, msg.sender, msg.content, msg.recipient , msg.k));
                    clients[findClient(ID)].send(new Message(msg.type, msg.sender, msg.content, msg.recipient , msg.k));
                }
            }
