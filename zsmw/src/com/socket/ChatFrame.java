...
public class ChatFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("       RECEIVED ENCRYPTED MESSAGE");
        jLabel7.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jLabel8.setText("        CHAT WINDOW");
...
//            }
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
          String plainString = jTextField4.getText();
          String target = jList1.getSelectedValue().toString();
        
        if(!plainString.isEmpty() && !target.isEmpty()){
          //  String encryptStr;
              try {
                  encryptStr = ae.encrypt(plainString);
            //      encryptStr = ae.encrypt(jTextArea1.getText()) ;
                 //  System.out.println(encryptStr);
                   
                   jTextField4.setText(" ");
                   message1 = new Message(username , target );
                   
                   System.out.println( "Encrypted message sent from" + message1.sender1 + "to" + message1.recipient1 ) ;
                   client.send(new Message("encryptdecrypt", username , encryptStr , target , "encrypt")) ;
              } catch (Exception ex) {
    ...
    try {
             // String msg1 = jTextArea2.getText() ;
               ...
               for( String l : arrayOfLines )
                    lines.add(l) ;
                      
              String decryptStr = null ;
           // EncryptSender = null  ;
          //    Message msgg = message1 ;
        if( txt!= null && !txt.isEmpty()) 
        {                 
                         int n = lines.size() ;
                         String aa = lines.get(n-1) ;
                         decryptStr = ae.decrypt( aa , ae.encryptionKey );
         
                        if( !decryptStr.isEmpty())
                        {          
                              //  jTextArea2.setText(" ") ;                          
                                jTextArea1.append( decryptStr + "\n");
                                              
                               // client.send( new Message( "encryptdecrypt" , username , decryptStr , username , "decrypt")) ;}
                        }else
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        client.send( new Message("askForKey" , username , "askForKey" , target)) ;
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
         try {
               ...
               PublicKey publicKey = rsa.readPublicKeyFromFile("./public.key");
               System.out.println(publicKey) ;
               byte[] PUBLICbytes = publicKey.getEncoded();
               client.send( new Message("keySent" , username ,"keySent", target, PUBLICbytes)) ; //k at end
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        try {
            ...
            String plainString = jTextField4.getText(); //text
            String target = jList1.getSelectedValue().toString(); //jisne privatekey bheji

            //   File f = new File("publicKey.txt");
//                    FileInputStream fis = new FileInputStream("publicKey.txt");
//                    DataInputStream dis = new DataInputStream(fis) ;
//                   
//                    byte[] keybytes = new byte[(int)fis.length()];
//                    dis.readFully(keybytes) ;
//                    dis.close() ;

            Path path = Paths.get("./publicKey"); //reads publickey from file
            ...
            //      PublicKey publicKey = rsa.readPublicKeyFromFile("public.key") ;
            String AESstring = rsa.generateAESkey();
          ...
          if (plainString != null) {
                ...
                encryptStr = rsa.encryptTextUsingAES(plainString, AESstring);
              
                aesEncoded = rsa.encryptAESKey(AESstring, pk);
 
                client.send(new Message("encryptdecrypt", username, encryptStr, aesEncoded, target, "encryptRSA"));
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
         try {
                ...
                if (txt != null && !txt.isEmpty()) {
                    int n = lines.size();
                    String aa = lines.get(n - 1); //key
                    String bb = lines.get(n - 2); //text

                    PrivateKey privKey = rsa.readPrivateKeyFromFile("./private.key");

                    String aesDecoded = rsa.decryptAESKey(aa, privKey);

                    System.out.println( "\n\n\n\nDECODED AES : " + aesDecoded ) ;
                    
                    decryptStr = rsa.decryptTextUsingAES(bb, aesDecoded);
